    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-sm-10 offset-sm-1 col-lg-8 offset-lg-2 col-xl-6 offset-xl-3">
                <h1 class="section__title section__title--page">Contacts</h1>
    ...
    <div class="container">
        <div class="row row--grid">
            <div class="col-12 col-lg-7 col-xl-8">
                <form class="form form--contacts form--contacts-page" action="{{ route('contact.save') }}">
                    <input type="text" class="form__input" required name="name" id="name" placeholder="Full Name" value="{{ old('name') }}">
                    <br>
                    <span class="text-danger">@error('name'){{ $message }}@enderror</span>

                    <input type="text" name="email" class="form__input" placeholder="Email" value="{{ old('email') }}">
                    <br><span class="text-danger">@error('email'){{ $message }}@enderror</span>

                    <input type="text" name="subject" class="form__input" placeholder="Subject" value="{{ old('subject') }}">
                    <br><span class="text-danger">@error('subject'){{ $message }}@enderror</span>

                    <textarea class="form__textarea" placeholder="Message" name="message">{{ old('message') }}</textarea>
            ...
            <div class="col-12 col-md-6 col-lg-5 col-xl-4">
                ...
                <p class="section__text section__text--sidebar">Interested in collaborating with us or seeking further information about our platform? Feel free to complete the form below to reach out to us. Our dedicated team of experienced customer care agents is available 24/7 to ensure that we assist you whenever you require our support.</p>
                <ul class="contacts__list">
                    <li><a href="tel:{{ config('settings.site.phone')[0] }}">{{ config('settings.site.phone')[0] }}</a></li>
                    <li><a href="mailto:{{ config('settings.site.email.info') }}">{{ config('settings.site.email.info') }}</a></li>
                </ul>
                {{-- <ul class="contacts__social">
                    <li><a href="https://smartmine.volkovdesign.com/contacts.html#" target="_blank"><svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 15C0 6.71573 6.71573 0 15 0C23.2843 0 30 6.71573 30 15C30 23.2843 23.2843 30 15 30C6.71573 30 0 23.2843 0 15Z" fill="#3B5998"></path><path d="M16.5634 23.8197V15.6589H18.8161L19.1147 12.8466H16.5634L16.5672 11.4391C16.5672 10.7056 16.6369 10.3126 17.6904 10.3126H19.0987V7.5H16.8457C14.1394 7.5 13.1869 8.86425 13.1869 11.1585V12.8469H11.4999V15.6592H13.1869V23.8197H16.5634Z" fill="white"></path></svg></a></li>
...
<section class="page_header"
    style="background: url({{ asset('assets/open/images/contact.jpg') }}) no-repeat !important;">
    <div class="container">
        <div class="row">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="contact_detail padding-bottom">
                    ...
                    <p class="bottom30">Interested in collaborating with us or seeking further information about our platform? Feel free to complete the form below to reach out to us. Our dedicated team of experienced customer care agents is available 24/7 to ensure that we assist you whenever you require our support.</p>
                    <p class="bottom20">With our pioneering pricing, consolidated liquidity, and precision execution algorithm aimed at securing optimal prices, we eliminate the complexities of mining within a crypto pool. Our team of experts handles all the necessary tasks on your behalf.</p>
                    <h3 class="bottom20">Our Address</h3>
                    <p>We've established multiple communication channels to ensure swift and convenient contact with us at any moment. All of these channels are accessible round the clock, 24/7.</p>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="address">
                                ...
                                <div class="text">
                                    <h4>Phone</h4>
                                    <a href="{{ config('settings.site.socials.whatsapp.link') }}">{{ config('settings.site.phone')[0] }}</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="address">
                                ...
                                <div class="text">
                                    <h4>Email Address</h4>
                                    <p><a href="mailto:{{ config('settings.site.email.info') }}">{{
                                            config('settings.site.email.info') }}</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                <div class="col-sm-12">
                    <div class="mapouter">
                        <div class="gmap_canvas"><iframe width="100%" height="400" frameborder="0" scrolling="no"
                                marginheight="0" marginwidth="0"
                                src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=3500 Deer Creek Road, Palo Alto 94304 CA USA&amp;t=&amp;z=11&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe><a
