@extends('layouts.dashboard.app', ['title' => 'Add Plan Timing'])
...
<div class="row">
    <div class="col-xl-10 mx-auto">
        <div class="col-lg-10 mx-auto">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Add Plan time</h4>
                    @if ($errors->any())
                    ...
                    <div class="pe-3" data-simplebar>
                        <form action="{{ route('admin.pricing.time.add.save') }}" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                @csrf
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label class="form-label" for="suffix">Suffix</label>
                                        <input type="text" class="form-control" id="suffix" name="suffix" placeholder="Plan suffix*" value="{{ old('suffix') }}">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="hours" name="hours" placeholder="Plan hours*" value="{{ old('hours') }}">
                                    ...
                                    <div class="col-md-6 text-center mx-auto col-12">
                                        <button type="submit" class="btn btn-primary" type="submit">Add Plan time</button>
                                    </div>
                            </div>
                        </form>
                    </div>
