@extends('layouts.dashboard.app', ['title' => 'Add a new Post'])
@section('css')
    <!--quill css-->
                ...
                <div class="col-xl-8 col-lg-8 mx-auto col-md-8">
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="">
                                <!-- end row -->
                                <h4 class="font-size-18 text-muted mt-1 text-center">Add Post</h4>
                                <p class="mb-3 text-center">Add a new Post for Blog Post</p>
                                <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{ route('admin.posts.add.save') }}">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-1">
                                            ...
                                            <input class="form-control" name="title" type="text" placeholder="Post Title..." value="{{ old('title') }}" id="title">
                                            @error('title')<span class="text-danger">{{ $message }}</span>@enderror
                                        </div>

                                        <div class="col-md-12 mb-1">
                                            <label for="sub_title" class="col-md-12 col-form-label">Sub Title</label>
                                            <input class="form-control" name="sub_title" placeholder="Post Sub Title..." value="{{ old('sub_title') }}">
                                            ...
                                            <label for="cat_id" class="col-md-12 col-form-label">Post Category</label>
                                                <select name="cat_id" class="form-select">
                                                    ...
                                                    @foreach ($categories as $category)
                                                        <option @if (old('cat_id') == $category->id) selected @endif value="{{ $category->id }}">{{ $category->title }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-12 mb-1">
                                            ...
                                            <textarea class="form-control" name="body" id="elm2" placeholder="Body of Post..." rows="3">{{ old('body') }}</textarea>
