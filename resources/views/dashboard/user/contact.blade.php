@extends('layouts.dashboard.app', ['title' => 'Contact Us'])
@section('css')
                        ...
                        <tbody>
                            @foreach($tickets as $ticket)
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-outline-success btn-sm waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center{{ $ticket->ref }}"><i class="mdi mdi-eye-check"></i> View</button>
                                        <button type="button" class="btn btn-outline-danger btn-sm waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-example-modal-centerdel{{ $ticket->ref }}"><i class="mdi mdi-delete"></i> Delete</button>
