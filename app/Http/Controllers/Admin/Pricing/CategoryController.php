...
class CategoryController extends Controller
{
    ...
    public function all(){
        return view('dashboard.admin.pricing.category.index', [
            'categories' => PlanCategory::orderBy('created_at', 'desc')->paginate(15)
        ]);
    }

    public function add(){
        return view('dashboard.admin.pricing.category.add'); //, ['types' => $this->types]);
    }
    ...
    public function addSave(Request $request){
        ...
        return redirect()->route('admin.pricing.category.all');
    }

    
    public function edit($category_id){
        return view('dashboard.admin.pricing.category.edit', [
