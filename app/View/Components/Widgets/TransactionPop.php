...
class TransactionPop extends Component
{
    /**
    ...
    public function picker(){
        ...
        $cuurrenciesArray = $currenies->toArray();
    ...
    public function transaction(){
        ...
        for($i = 0; $i < 11; $i++){
            $coma = ($i == 10) ? '' : ',';
            $transaction_list .= $this->pickerT() . $coma;
        }
        //dd($transaction_list);
    ...
    public function pickerT()
    {
        $counrtyPicked = array_rand($this->counrty);
        $namesPicked = rand(0, (count($this->names) - 1));
        $type = rand(0, 1) ? 'withdrew' : 'deposited';
        // return [$names[$namesPicked] , $counrty[$counrtyPicked]['name'] , rand(50,99999),  $type];
        return "['" .$this->names[$namesPicked] . "', '" . $this->counrty[$counrtyPicked]['name'] . "', " . rand(50,20000) . ", '$type']";
    }
    ...
    {
        return view('components.widgets.transaction-pop');
    }
}